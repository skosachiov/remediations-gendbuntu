...
CMDLINE="root=/dev/mapper/crypt-root ro rd.auto rd.luks=1 rd.luks.options=tpm2-device=auto,tpm2-measure-pcr=yes systemd.decrypt_tpm2=yes rootflags=subvol=@rootfs quiet"
