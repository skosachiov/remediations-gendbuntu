...
CMDLINE="root=/dev/mapper/crypt-root ro rd.auto rd.luks=1 rd.luks.crypttab=0 rd.luks.options=tpm2-device=auto,tpm2-measure-pcr=yes rootflags=subvol=@rootfs quiet"
