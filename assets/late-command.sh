...
echo '@reboot root bash -c "sleep 90 && /usr/bin/ansible-pull -i localhost -t dummy -U https://github.com/skosachiov/remediations-gendbuntu.git workstation-test.yml | logger"' >> /etc/cron.d/ansible-pull
